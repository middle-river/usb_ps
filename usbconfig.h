 ...
 */
#define USB_CFG_VENDOR_NAME     'm', 'i', 'd', 'd', 'l', 'e', 'r', 'i', 'v', 'e', 'r', '0', '@', 'g', 'm', 'a', 'i', 'l', '.', 'c', 'o', 'm'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'U', 'S', 'B', '-', 'S', 'W'
...
#define USB_CFG_DESCR_PROPS_DEVICE   (USB_PROP_IS_RAM | USB_PROP_LENGTH(8))
 *
